...
u8 KPD_u8GetPressedKey(void)
{
	...
	/*	4 rows as an input	*/
	DIO_u8SetPinDirection(KPD_PORT,KPD_ROW0_PIN,DIO_u8_PIN_INPUT);
	DIO_u8SetPinDirection(KPD_PORT,KPD_ROW1_PIN,DIO_u8_PIN_INPUT);
	DIO_u8SetPinDirection(KPD_PORT,KPD_ROW2_PIN,DIO_u8_PIN_INPUT);
	DIO_u8SetPinDirection(KPD_PORT,KPD_ROW3_PIN,DIO_u8_PIN_INPUT);
